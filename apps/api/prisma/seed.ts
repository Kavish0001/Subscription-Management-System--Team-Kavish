...
const mediaUrls = (slug: string, count: number) => Array.from({ length: count }, (_, i) => `https://picsum.photos/seed/${slug}-${i + 1}/1200/900`);
...
async function main() {
  ...
  for (let i = 0; i < PRODUCT_COUNT; i += 1) {
    ...
    const product = await prisma.product.create({
      data: {
        ...
        isActive: i % 19 !== 0,
        imageUrl: mediaUrls(slug, 3)[0],
        imageUrls: mediaUrls(slug, 2 + (i % 3)),
  ...
  const subDefs = [
    ...
    ['005', 4, 0, 'Seed Monthly Core', SubscriptionStatus.in_progress, 'Immediate payment', 3, 1, 'Seed Starter Monthly Proposal', undefined, 'SEEDWELCOME10', undefined, undefined, -20, undefined, -18, -18, 12, undefined, 'Portal active subscription'],
    ['006', 5, 1, 'Seed Monthly Enterprise', SubscriptionStatus.in_progress, '50% advance', 44, 5, undefined, undefined, 'SEEDTEAM15', undefined, undefined, -30, undefined, -28, -28, -2, undefined, 'Enterprise account'],
    ['007', 6, 2, 'Seed Monthly Core', SubscriptionStatus.paused, 'Net 15', 14, 1, undefined, undefined, undefined, undefined, undefined, -24, undefined, -21, -21, 7, undefined, 'Paused subscription'],
    ['008', 7, 3, 'Seed Weekly Rental', SubscriptionStatus.closed, 'Immediate payment', 30, 1, undefined, undefined, undefined, undefined, undefined, -60, undefined, -56, -56, -28, -7, 'Closed rental'],
    ['009', 8, 4, 'Seed Monthly Core', SubscriptionStatus.cancelled, 'Net 7', 6, 2, undefined, undefined, undefined, undefined, undefined, -8, 2, -6, -5, 25, undefined, 'Cancelled subscription'],
    ['010', 9, 0, 'Seed Annual Enterprise', SubscriptionStatus.in_progress, 'Net 30', 70, 10, undefined, undefined, undefined, undefined, undefined, -40, undefined, -35, -35, 20, undefined, 'Enterprise annual'],
  ] as const;
