...
async function main() {
  ...
  for (const [code, customerIndex, sellerIndex, planName, status, term, productIndex, quantity, templateName, relationType, discountCode, parentIndex, , quotationDays, expiryDays, confirmedDays, startDays, nextInvoiceDays, expirationDays, notes] of subDefs) {
